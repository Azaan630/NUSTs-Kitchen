-- ============================================================================
-- COMPREHENSIVE DATABASE RESET & SEED SCRIPT
-- Erases all data and loads thorough test data covering every app feature.
-- Run: run_init.py (after this script) or `source db/full_seed.sql` in MySQL
-- ============================================================================
...
-- ============================================================================
-- USERS (10 total: 1 Admin + 2 Staff + 7 Students)
-- ============================================================================
...
-- ============================================================================
-- STAFF CONTACT NUMBERS (multivalued attribute)
-- ============================================================================
...
-- ============================================================================
-- INGREDIENTS (20 items with images)
-- ============================================================================
...
-- ============================================================================
-- FOOD ITEMS (15 dishes with images)
-- ============================================================================
...
-- ============================================================================
-- MENU → FOOD ITEMS MAPPING
-- ============================================================================
INSERT INTO Menu_Food_Items (Schedule_ID, Item_ID) VALUES
(1, 3),  (1, 10), (1, 4),                    -- Day 1 Breakfast: Tea, Omelette, Paratha
(2, 1),  (2, 5),  (2, 7),                     -- Day 1 Lunch: Biryani, Karahi, Roti
(3, 2),  (3, 6),  (3, 7),                     -- Day 1 Dinner: Daal, Mixed Veg, Roti
(4, 4),  (4, 3),  (4, 10),                   -- Day 2 Breakfast: Paratha, Tea, Omelette
(5, 9),  (5, 12), (5, 7),                    -- Day 2 Lunch: Pulao, Tikka, Roti
(6, 8),  (6, 14), (6, 7),                    -- Day 2 Dinner: Nihari, Keema Naan, Roti
(7, 10), (7, 4),  (7, 3),                    -- Day 3 Breakfast: Omelette, Paratha, Tea
(8, 1),  (8, 6),                              -- Day 3 Lunch: Biryani, Mixed Veg
(9, 2),  (9, 14),                             -- Day 3 Dinner: Daal, Keema Naan
(10, 3), (10, 10), (10, 13),                 -- Day 4 Breakfast: Tea, Omelette, Fruit Chaat
(11, 5), (11, 7),                              -- Day 4 Lunch: Karahi, Roti
(12, 11),(12, 7),                             -- Day 4 Dinner: Haleem, Roti
(13, 4), (13, 3),                              -- Day 5 Breakfast: Paratha, Tea
(14, 8), (14, 7),                              -- Day 5 Lunch: Nihari, Roti
(15, 9), (15, 6), (15, 7),                    -- Day 5 Dinner: Pulao, Mixed Veg, Roti
(16, 10),(16, 4), (16, 15),                  -- Day 6 Breakfast: Omelette, Paratha, Gulab Jamun
(17, 12),(17, 1),                              -- Day 6 Lunch: Tikka, Biryani
(18, 2), (18, 7), (18, 15),                   -- Day 6 Dinner: Daal, Roti, Gulab Jamun
(19, 13),(19, 3),                              -- Day 7 Breakfast: Fruit Chaat, Tea
(20, 5), (20, 9), (20, 7),                    -- Day 7 Lunch: Karahi, Pulao, Roti
(21, 11),(21, 14), (21, 7);                   -- Day 7 Dinner: Haleem, Keema Naan, Roti
...
(8,  DATE_ADD(CURDATE(), INTERVAL -2 DAY),  DATE_ADD(CURDATE(), INTERVAL 1 DAY),   'Approved'),
(9,  DATE_ADD(CURDATE(), INTERVAL 10 DAY),  DATE_ADD(CURDATE(), INTERVAL 14 DAY),  'Pending'),
(2,  DATE_ADD(CURDATE(), INTERVAL -5 DAY),  DATE_ADD(CURDATE(), INTERVAL -2 DAY),  'Rejected'),
...
-- ============================================================================
-- TRANSACTIONS (for paid/partially paid bills)
-- ============================================================================
